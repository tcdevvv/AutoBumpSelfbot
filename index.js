...
client.on('ready', async () => {
    ...
    try {
        ...
        // Log the loaded channels with server info
        ...
        for (const id of channelIds) {
            try {
                ...
                console.error(`Error fetching channel ID ${id}:`, error)
            }
        }

        // Log the loaded roles with server info
        console.log('\n--- Loaded Roles ---')
        ...
        // Listen for messages and check for role pings
